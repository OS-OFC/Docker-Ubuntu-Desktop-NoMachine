...
docker run --rm -d --network host --privileged --name nomachine-xfce4 -e PASSWORD=bakrine -e USER=oussama --cap-add=SYS_PTRACE --shm-size=1g thuonghai2711/nomachine-ubuntu-desktop:windows10
clear
